...
- Page 1: "X" -> `R1_2` (checkbox)
- Page 1: "TECHNICIAN" -> `R1_3` (checkbox)
- Page 1: "SENIOR TECHNICIAN" -> `R1_4` (checkbox)
...
- Page 1: "X" -> `R1_12` (checkbox)
- Page 1: "TUES" -> `R1_14` (checkbox)
- Page 1: "WED" -> `R1_16` (checkbox)
- Page 1: "THURS" -> `R1_18` (checkbox)
...
- Page 2: "(print name):" -> `R2_5` (input_field)
- Page 2: "(print name):" -> `R2_6` (input_field)
- Page 2: "(print name):" -> `R2_7` (input_field)
- Page 2: "COMMENTS:" -> `R2_8` (signature_field)
